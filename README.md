...
- Create a `.env` file in the root directory and add the environment variables defined in `.env.example`.
- Run `make development-up` to download images and set up containers.
