...
- Create a `.env.development` file in the root directory and add the environment variables defined in `.env.example`.
- Run `make dev-up` to download images and set up containers.
